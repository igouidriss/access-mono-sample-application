...
export const Table2DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="accessMonoSampleApplicationApp.table2.delete.question">
        <Translate contentKey="accessMonoSampleApplicationApp.table2.delete.question" interpolate={{ id: table2Entity.id }}>
