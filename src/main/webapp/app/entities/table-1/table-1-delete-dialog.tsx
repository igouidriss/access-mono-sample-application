...
export const Table1DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="accessMonoSampleApplicationApp.table1.delete.question">
        <Translate contentKey="accessMonoSampleApplicationApp.table1.delete.question" interpolate={{ id: table1Entity.id }}>
