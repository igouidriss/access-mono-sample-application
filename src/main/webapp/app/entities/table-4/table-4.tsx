  ...
  return (
    <div>
      <h2 id="table-4-heading" data-cy="Table4Heading">
        <Translate contentKey="accessMonoSampleApplicationApp.table4.home.title">Table 4 S</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="accessMonoSampleApplicationApp.table4.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/table-4/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="accessMonoSampleApplicationApp.table4.home.createLabel">Create new Table 4</Translate>
          </Link>
        </div>
      </h2>
        ...
        {table4List && table4List.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('descriptionTypeChbDeResv50')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.descriptionTypeChbDeResv50">
                ...
                <th className="hand" onClick={sort('codeTypeChbDeResv51')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.codeTypeChbDeResv51">Code Type Chb De Resv 51</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('codeTypeChbDeResv51')} />
                </th>
                <th className="hand" onClick={sort('statutDeReservation52')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.statutDeReservation52">Statut De Reservation 52</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('statutDeReservation52')} />
                </th>
                <th className="hand" onClick={sort('circuitDistribution53')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.circuitDistribution53">Circuit Distribution 53</Translate>{' '}
                ...
                <th className="hand" onClick={sort('circuitDistribUserRegroup54')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.circuitDistribUserRegroup54">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal88')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeChambreGlobal88">
                ...
                <th className="hand" onClick={sort('revenuNetBq89')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetBq89">Revenu Net Bq 89</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetBq89')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeBq90')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeBq90">Revenu Taxe Bq 90</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeBq90')} />
                </th>
                <th className="hand" onClick={sort('revenuNetBqGlobal91')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetBqGlobal91">Revenu Net Bq Global 91</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetBqGlobal91')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeBqGlobal92')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeBqGlobal92">Revenu Taxe Bq Global 92</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeBqGlobal92')} />
                </th>
                <th className="hand" onClick={sort('revenuNetExtra93')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetExtra93">Revenu Net Extra 93</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetExtra93')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeExtra94')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeExtra94">Revenu Taxe Extra 94</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeExtra94')} />
                </th>
                <th className="hand" onClick={sort('revenuNetExtraGlobal95')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetExtraGlobal95">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal96')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeExtraGlobal96">
                ...
                <th className="hand" onClick={sort('revenuNetTotal97')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetTotal97">Revenu Net Total 97</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetTotal97')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeTotal98')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeTotal98">Revenu Taxe Total 98</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeTotal98')} />
                </th>
                <th className="hand" onClick={sort('revenuNetTotalGlobal99')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetTotalGlobal99">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal100')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeTotalGlobal100">
                ...
                <th className="hand" onClick={sort('prodRevenuChambre101')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuChambre101">Prod Revenu Chambre 101</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuChambre101')} />
                </th>
                <th className="hand" onClick={sort('prodRevenuBq102')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuBq102">Prod Revenu Bq 102</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuBq102')} />
                </th>
                <th className="hand" onClick={sort('prodRevenuExtra103')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuExtra103">Prod Revenu Extra 103</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuExtra103')} />
                </th>
                <th className="hand" onClick={sort('prodRevenuTotal104')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuTotal104">Prod Revenu Total 104</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuTotal104')} />
                </th>
                <th className="hand" onClick={sort('prodChambreNbNuitees105')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodChambreNbNuitees105">
                ...
                <th className="hand" onClick={sort('descriptionTypeChbDeResv157')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.descriptionTypeChbDeResv157">
                ...
                <th className="hand" onClick={sort('codeTypeChbDeResv158')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.codeTypeChbDeResv158">Code Type Chb De Resv 158</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('codeTypeChbDeResv158')} />
                </th>
                <th className="hand" onClick={sort('statutDeReservation159')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.statutDeReservation159">Statut De Reservation 159</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('statutDeReservation159')} />
                </th>
                <th className="hand" onClick={sort('circuitDistribution160')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.circuitDistribution160">Circuit Distribution 160</Translate>{' '}
                ...
                <th className="hand" onClick={sort('circuitDistribUserRegroup161')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.circuitDistribUserRegroup161">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal195')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeChambreGlobal195">
                ...
                <th className="hand" onClick={sort('revenuNetBq196')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetBq196">Revenu Net Bq 196</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetBq196')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeBq197')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeBq197">Revenu Taxe Bq 197</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeBq197')} />
                </th>
                <th className="hand" onClick={sort('revenuNetBqGlobal198')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetBqGlobal198">Revenu Net Bq Global 198</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetBqGlobal198')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeBqGlobal199')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeBqGlobal199">Revenu Taxe Bq Global 199</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeBqGlobal199')} />
                </th>
                <th className="hand" onClick={sort('revenuNetExtra200')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetExtra200">Revenu Net Extra 200</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetExtra200')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeExtra201')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeExtra201">Revenu Taxe Extra 201</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeExtra201')} />
                </th>
                <th className="hand" onClick={sort('revenuNetExtraGlobal202')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetExtraGlobal202">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal203')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeExtraGlobal203">
                ...
                <th className="hand" onClick={sort('revenuNetTotal204')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetTotal204">Revenu Net Total 204</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetTotal204')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeTotal205')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeTotal205">Revenu Taxe Total 205</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeTotal205')} />
                </th>
                <th className="hand" onClick={sort('revenuNetTotalGlobal206')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetTotalGlobal206">
                ...
                <th className="hand" onClick={sort('revenuTaxeTotalGlobal207')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeTotalGlobal207">
                ...
                <th className="hand" onClick={sort('prodRevenuChambre208')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuChambre208">Prod Revenu Chambre 208</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuChambre208')} />
                </th>
                <th className="hand" onClick={sort('prodRevenuBq209')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuBq209">Prod Revenu Bq 209</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuBq209')} />
                </th>
                <th className="hand" onClick={sort('prodRevenuExtra210')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuExtra210">Prod Revenu Extra 210</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuExtra210')} />
                </th>
                <th className="hand" onClick={sort('prodRevenuTotal211')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodRevenuTotal211">Prod Revenu Total 211</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('prodRevenuTotal211')} />
                </th>
                <th className="hand" onClick={sort('prodChambreNbNuitees212')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.prodChambreNbNuitees212">
                ...
                <th className="hand" onClick={sort('descriptionTypeChbDeResv264')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.descriptionTypeChbDeResv264">
                ...
                <th className="hand" onClick={sort('codeTypeChbDeResv265')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.codeTypeChbDeResv265">Code Type Chb De Resv 265</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('codeTypeChbDeResv265')} />
                </th>
                <th className="hand" onClick={sort('statutDeReservation266')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.statutDeReservation266">Statut De Reservation 266</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('statutDeReservation266')} />
                </th>
                <th className="hand" onClick={sort('circuitDistribution267')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.circuitDistribution267">Circuit Distribution 267</Translate>{' '}
                ...
                <th className="hand" onClick={sort('circuitDistribUserRegroup268')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.circuitDistribUserRegroup268">
                ...
                <th className="hand" onClick={sort('revenuTaxeChambreGlobal302')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeChambreGlobal302">
                ...
                <th className="hand" onClick={sort('revenuNetBq303')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetBq303">Revenu Net Bq 303</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetBq303')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeBq304')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeBq304">Revenu Taxe Bq 304</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeBq304')} />
                </th>
                <th className="hand" onClick={sort('revenuNetBqGlobal305')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetBqGlobal305">Revenu Net Bq Global 305</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetBqGlobal305')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeBqGlobal306')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeBqGlobal306">Revenu Taxe Bq Global 306</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeBqGlobal306')} />
                </th>
                <th className="hand" onClick={sort('revenuNetExtra307')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetExtra307">Revenu Net Extra 307</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuNetExtra307')} />
                </th>
                <th className="hand" onClick={sort('revenuTaxeExtra308')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeExtra308">Revenu Taxe Extra 308</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('revenuTaxeExtra308')} />
                </th>
                <th className="hand" onClick={sort('revenuNetExtraGlobal309')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuNetExtraGlobal309">
                ...
                <th className="hand" onClick={sort('revenuTaxeExtraGlobal310')}>
                  <Translate contentKey="accessMonoSampleApplicationApp.table4.revenuTaxeExtraGlobal310">
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="accessMonoSampleApplicationApp.table4.home.notFound">No Table 4 S found</Translate>
            </div>
          )
        )}
      </div>
