...
export const Table4DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="accessMonoSampleApplicationApp.table4.delete.question">
        <Translate contentKey="accessMonoSampleApplicationApp.table4.delete.question" interpolate={{ id: table4Entity.id }}>
