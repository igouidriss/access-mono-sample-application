...
export const Table5DeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="accessMonoSampleApplicationApp.table5.delete.question">
        <Translate contentKey="accessMonoSampleApplicationApp.table5.delete.question" interpolate={{ id: table5Entity.id }}>
